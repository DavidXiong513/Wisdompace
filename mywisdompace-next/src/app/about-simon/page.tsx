...
const FACES = [
  {
    icon: "💼",
    title: "作为咨询顾问的我",
    text: "近20年，125家企业客户，500+位个人客户。我见过职场最残酷的一面，也见证过最美的蜕变。如果你正在职业的十字路口，我或许能帮你看清路。",
  },
  {
    icon: "🪷",
    title: "作为修行持戒居士的我",
...
const CREDENTIALS = [
  ...
  { label: "中欧商学院 CEIBS", sub: "高绩效团队与领导组织发展" },
    ...
    <section id="timeline" className="as-section">
      <div className="as-container">
        ...
        <div className="relative">
          {/* 竖线 */}
          <div className="absolute left-4 top-0 h-full w-0.5 bg-[var(--as-primary-100)] sm:left-1/2 sm:-translate-x-px" />
          ...
          <div className="space-y-5">
            {TIMELINE.map((item, i) => (
              ...
              >
                ...
                {/* 卡片 */}
                <div className={`ml-10 w-full sm:ml-0 sm:w-[calc(50%-2rem)] ${i % 2 === 0 ? "sm:pr-8" : "sm:pl-8"}`}>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {CAPABILITIES.map((cap) => (
            <div key={cap.name} className="as-card flex items-center gap-3 p-4">
              ...
              <h3 className="text-sm font-semibold text-[var(--as-primary-800)]">
                {cap.name}
              </h3>
            </div>
          ))}
      ...
      <div className="as-container">
        ...
        <div className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-4">
          {CREDENTIALS.map((cred) => (
            ...
            >
              <p className="text-sm font-semibold text-[var(--as-primary-700)]">
                {cred.label}
              </p>
              <p className="mt-0.5 text-xs text-[var(--as-gray-500)]">
                {cred.sub}
              </p>
            </div>
          ))}
