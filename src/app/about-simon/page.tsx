...
const TIMELINE = [
  ...
  },
  {
    year: '2017-2020',
    title: '创业历练',
    desc: '奕尚电商（后被宝尊收购）HR&Admin负责人 + 盟广信息（后被华住并入）HRD，从0到1的组织搭建，理解创业公司的生存法则',
  },
  {
    year: '2020-2021',
    title: '互联网大厂',
...
const FACES = [
  ...
  },
  {
    icon: '🏢',
    title: '作为HR高管的我',
    text: '从2016年起，我在上市集团、外企、民企和创业公司担任HR一号位。面过上万人，也裁过数千人，亲手操盘过组织变革、人才战略、文化重塑和人效提升。合资、外企、民营、创业——每一种组织生态我都沉浸式体验过。这些经历让我既懂组织的逻辑，也懂个体的挣扎。如果你正卡在职场困局里，我或许能帮你找到出口。',
  },
  {
    icon: '🪷',
    title: '作为修行持戒居士的我',
