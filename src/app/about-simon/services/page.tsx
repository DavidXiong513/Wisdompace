    ...
    <div className="as-with-sidebar">
        ...
        <div className="as-container">
          ...
          <div className="mx-auto max-w-4xl space-y-4">
            ...
            <p className="text-sm leading-relaxed text-[var(--as-gray-600)]">
              ...
              我也见过被裁后反而松了一口气的中年人：他说&ldquo;我早就想走了，只是一直没有勇气&rdquo;。
            </p>

            <p className="text-sm leading-relaxed text-[var(--as-gray-600)]">
              我能做的，不是在&ldquo;冷酷&rdquo;和&ldquo;温情&rdquo;之间做选择——因为这件事本身就充满矛盾的张力。
          ...
          <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <div key={d.label} className="rounded-lg bg-white p-4 text-center shadow-sm">
                ...
                <p className="mt-1 text-xs text-[var(--as-gray-500)]">{d.label}</p>
              </div>
            ))}
          </div>
      ...
      <section className="as-section">
        <div className="text-center">
          <p className="text-[var(--as-gray-500)]">想看看我写了什么？</p>
          <Link
            scroll={false}
